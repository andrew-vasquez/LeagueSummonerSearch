...
const lastPlayed = (unixDate) =>{
  ...
  function masterLevel(level){
    if (level === 7){
     return <img src={masteryImages.Mastery7} alt="Champ Mastery Icon" className="w-10 -mb-8  relative"/>
    } else if (level === 6){
      return <img src={masteryImages.Mastery6} alt="Champ Mastery Icon" className="w-10 -mb-8  relative"/>
    } else if (level === 5){
      return <img src={masteryImages.Mastery5} alt="Champ Mastery Icon" className="w-10 -mb-8  relative"/>
    } else if (level === 4){
      return <img src={masteryImages.Mastery4} alt="Champ Mastery Icon" className="w-10 -mb-8  relative"/>
    } else if (level === 3){
      return <img src={masteryImages.Mastery3} alt="Champ Mastery Icon" className="w-10 -mb-8  relative"/>
    } else if (level === 2){
      return <img src={masteryImages.Mastery2} alt="Champ Mastery Icon" className="w-10 -mb-8  relative"/>
    } else if (level === 1){
      return <img src={masteryImages.Mastery1} alt="Champ Mastery Icon" className="w-10 -mb-8  relative"/>
    }
  }
  ...
  function soloImg (tier){
    ...
    if (tier === "PLATINUM"){
    return <img src={rankImages.Platinum} alt=""  className="pb-5 w-20 place-self-center md:place-content-start"/>
  }
    else if (tier === "GOLD"){
    ...
    return <img src={rankImages.Bronze} alt=""  className="pb-5 w-20 place-self-center md:place-content-start"/>
  } else if (tier === "DIAMOND"){
    return <img src={rankImages.Diamond} alt=""  className="pb-5 w-20 place-self-center md:place-content-start"/>
  } else if (tier === "MASTER"){
    return <img src={rankImages.Master} alt=""  className="pb-5 w-20 place-self-center md:place-content-start"/>
  }else if (tier === "GRANDMASTER"){
    return <img src={rankImages.Grandmaster} alt=""  className="pb-5 w-20 place-self-center md:place-content-start"/>
  } else if (tier === "CHALLENGER"){
    return <img src={rankImages.Challenger} alt=""  className="pb-5 w-20 place-self-center md:place-content-start"/>
  } else return <img src={rankImages.Unranked} alt=""  className="pb-5 w-20 place-self-center md:place-content-start"/>
  }
            ...
            <div className="">
              ...
              <div className="pl-12 pt-6 flex flex-col md:flex-row align-text-top">
                {queue1.queueType === "RANKED_SOLO_5x5" ? (
                  <>
                  {soloImg(queue1.tier)}
                <p className="text-sm md:text-base md:pl-6 md:mt-8 ">{queue1.tier} {queue1.rank} {queue1.leaguePoints}LP</p>
            ...
            <div className="text-white flex ">
              ...
              <div className="place-self-start">
               {masterLevel(champ1.championLevel)}
                <img
                  src={`http://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/${champIdArray(champ1.championId)}.png`}
                  alt="champion"
                  className="w-36"
                />
              ...
              <div className=" pl-2  place-self-center mb-10">
                <h2 className="text-sm md:text-base">{champIdArray(champ1.championId)}</h2>
                <p className="text-xs md:text-sm">Last Played: {lastPlayed(champMastery[0].lastPlayTime)}</p>
              </div>
            </div>
            <div className="text-white flex ">
              {" "}
              ...
              {masterLevel(champ2.championLevel)}
                <img
                  src={`http://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/${champIdArray(champ2.championId)}.png`}
                  alt="champion"
                  className="w-36"
                />
                <p className="border-solid rounded-3xl inline-block bg-sumLevelBackground px-2 ml-5 md:text-lg">
              ...
              <div className=" pl-2  place-self-center mb-10">
                <h2 className="text-sm md:text-base">{champIdArray(champ2.championId)}</h2>
                <p className="text-xs md:text-sm">Last Played: {lastPlayed(champMastery[1].lastPlayTime)}</p>
              </div>
            </div>
            <div className="text-white flex ">
              {" "}
              ...
              {masterLevel(champ3.championLevel)}
                <img
                  src={`http://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/${champIdArray(champ3.championId)}.png`}
                  alt="champion"
                  className="w-36"
                />
                <p className="border-solid rounded-3xl inline-block bg-sumLevelBackground px-2 ml-5 md:text-lg">
              ...
              <div className=" pl-2  place-self-center mb-10">
                <h2 className="text-sm md:text-base">{champIdArray(champ3.championId)}</h2>
                <p className="text-xs md:text-sm">Last Played: {lastPlayed(champMastery[2].lastPlayTime)}</p>
              </div>
            </div>
            <div className="text-white flex ">
              {" "}
              ...
              {masterLevel(champ4.championLevel)}
                <img
                  src={`http://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/${champIdArray(champ4.championId)}.png`}
                  alt="champion"
                  className="w-36"
                />
                <p className="border-solid rounded-3xl inline-block bg-sumLevelBackground px-2 ml-5 md:text-lg">
              ...
              <div className=" pl-2  place-self-center mb-10">
                <h2 className="text-sm md:text-base">{champIdArray(champ4.championId)}</h2>
                <p className="text-xs md:text-sm">Last Played: {lastPlayed(champMastery[3].lastPlayTime)}</p>
              </div>
            </div>
            <div className="text-white flex ">
              {" "}
              ...
              {masterLevel(champ5.championLevel)}
                <img
                  src={`http://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/${champIdArray(champ5.championId)}.png`}
                  alt="champion"
                  className="w-36"
                />
                <p className="border-solid rounded-3xl inline-block bg-sumLevelBackground px-2 ml-5 md:text-lg">
              ...
              <div className=" pl-2  place-self-center mb-10">
                <h2 className="text-sm md:text-base">{champIdArray(champ5.championId)}</h2>
                <p className="text-xs md:text-sm">Last Played: {lastPlayed(champMastery[4].lastPlayTime)}</p>
              </div>
            </div>
            <div className="text-white flex ">
              {" "}
              ...
              {masterLevel(champ6.championLevel)}
                <img
                  src={`http://ddragon.leagueoflegends.com/cdn/12.19.1/img/champion/${champIdArray(champ6.championId)}.png`}
                  alt="champion"
                  className="w-36"
                />
                <p className="border-solid rounded-3xl inline-block bg-sumLevelBackground px-2 ml-5 md:text-lg">
              ...
              <div className=" pl-2  place-self-center mb-10">
                <h2 className="text-sm md:text-base">{champIdArray(champ6.championId)}</h2>
                <p className="text-xs md:text-sm">Last Played: {lastPlayed(champMastery[5].lastPlayTime)}</p>
              </div>
            </div>
          </div>
            ) :(
