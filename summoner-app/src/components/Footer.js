...
const Footer = () => {
  return (
    <footer className="bg-red-500 p-3 w-full flex flex-">
        ...
        <img src={companyLogos.gitHubBig} alt="" className='w-8 md:w-10 hover:bg-gray-600' />
        </a>
        <a className='mx-auto ' href="https://www.linkedin.com/in/andrew-vasquez-000434237/" target="_blank" rel="noreferrer noopener">
            <img src={companyLogos.linkedinLogo} alt="" className='w-8 md:w-10 hover:bg-gray-600' />
        </a>
    </footer>
  )
}
